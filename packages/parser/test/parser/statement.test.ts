...
import { TokenTypes } from "../../src/constants/jokerlangSpec";
import jokerlangModule from "../../src/module/jokerlangModule";

jest.mock("../../src/module/jokerlangModule");
...
test("test getStatementImpl of statement class with should success", () => {
  ...
  jokerlangModule.getBlockStatement = jest
    .fn()
  ...
  expect(jokerlangModule.getBlockStatement).toHaveBeenCalledTimes(1);
});
